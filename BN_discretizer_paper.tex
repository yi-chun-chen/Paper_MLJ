...
Section~\ref{sec:multi_var} covers Bayesian networks with multiple continuous variables and how to discretize while simultaneously learning network structure.
