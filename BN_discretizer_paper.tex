...
The objective function can be formulated given equations \todo{8,9,11,12}, and \ref{eq:likelihood_two}.
Instead of maximizing $P(M) \cdot P(D|M)$, the log-inverse is minimized for computational convenience.
