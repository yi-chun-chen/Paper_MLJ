...
Figure~\ref{fig:wine_exp2_distr} shows the discretization policy for variables $E$ and $K$ obtained with the \todo{heuristic Bayesian method}.
...
\begin{figure}[ht]
  ...
  \caption{The discrete-valued Bayesian network learned from the Wine dataset \todo{using the heuristic Bayesian method}.}
