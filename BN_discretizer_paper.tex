...
MDL discretization requires that the network structure be known in advance, but can be incorporated into the structure learning process.
...
Results in this work suggest that the MDL method suffers from low sensitivity to discretization edge locations and returns low numbers of discretization intervals on continuous variables.
This is caused by the MDL's use of mutual information to rate discretization edges.
