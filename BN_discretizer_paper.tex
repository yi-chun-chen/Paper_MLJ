...
For example, in Figure 1., the corresponding $P(D \mid M)$ is factorized as
\begin{equation}
...
Assume that $J_P = \prod_{i=1}^{n_p} | P_i |$. Then:
\begin{equation}
...
Assume for each pair of $(C_j, \boldsymbol{S_j})$, one has $|C_j | = J_j$ and $|\boldsymbol{S_j}| = L_j = \prod_{v \in \boldsymbol{S_j}} | v |$. Therefore,
\begin{equation}
