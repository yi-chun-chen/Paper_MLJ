...
Furthermore, emperical demonstrations show that the proposed method produces superior discretization schemes, evalated using the cross-validated log-likelihood.\\[0em]
