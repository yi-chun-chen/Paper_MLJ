...
Learning Bayesian networks from raw data can help users to interpret the relations between variables and acquire knowledge without field-specific experts.
...
Thus, continuous variables are often discretized while learning a Bayesian network. 
...
Empirical demonstrations show that the proposed method is superior to the classic method.
