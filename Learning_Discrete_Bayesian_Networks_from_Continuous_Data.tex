...
All following content sets $L$ to the largest number of intervals among discrete variables in $\cX$'s Markov blanket, which encourages Bayesian networks with consistent interval counts.
...
\begin{table}[ht]
    ...
    The Bayesian method consitently has highest likelihood.
	}
  \resizebox{\textwidth}{!}{
	 \input{Table3_2.tex}
  }
