...
\begin{tikzpicture}[
      ...
      \node[obs]                 (c2) {$B$};
      \node[latent, below left = 2.0 and 1.0 of c2]   (c3){$C$};
      \node[latent, left =5.0 of c2]   (c5){$E$};
      \node[latent, below left = 1.75 and 1.0 of c3] (c4){$D$};
      \node[obs, below left = 1.0 and 2.0 of c2] (c8){$H$};
      \node[latent, below = 0.5 of c4] (c6){$F$};
      \node[latent, left = 1.5 of c8] (c1){$A$};
      \node[obs, below left = 1.0  and 1.0 of c8] (c7) {$G$};
