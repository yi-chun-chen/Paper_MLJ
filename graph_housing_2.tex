...
\begin{tikzpicture}[
	  ...
	  \node[latent]          (c2) {$2$};
	  \node[latent, right = 2.0 of c2]  (c4){$4$};
	  \node[latent, below right = 1.0 and 1.0 of c2]  (c12){$12$};
	  \node[latent, below right = 1.0 and 1.0 of c12]  (c14){$14$};
	  \node[latent, below right = 1.0 and 1.0 of c14]  (c6){$6$};
	  \node[latent, below= 2.0 of c2]  (c7){$7$};
	  \node[latent, below = 2.0 of c12]  (c1){$1$};
	  \node[latent, below = 2.0 of c14]  (c13){$13$};
	  \node[latent, below left = 2.0 and 0.75 of c2] (c3){$3$};
	  \node[latent, below = 0.75 of c3]  (c10){$10$};
	  \node[latent, below left = 1.0 and 1.0 of c3] (c5){$5$};
	  \node[latent, left = 1.0 of c5] (c11){$11$};
	  \node[latent, left = 1.0 of c11] (c8){$8$};
	  \node[latent, left = 3.5 of c3] (c9){$9$};
